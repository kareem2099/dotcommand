# DotCommand Changelog

## [1.4.0] - 2026-01-13

🧠 Smart Context Awareness - Extension now understands your project and suggests relevant commands automatically
...
- Status bar button for instant top suggestions
- `Ctrl+Alt+Space` keyboard shortcut for suggestion picker
- Native VS Code file/folder pickers instead of text input
- Git branch dropdown integration

### 🏗️ Framework Support
- **React**: Components, hooks, contexts, production builds
- **Vue**: SFC components, composables, production builds
- **Angular**: CLI generators, dev server, production builds
- **TypeScript**: Compilation, interfaces, type checking
- **Go/Python/Rust**: Full development workflows

### 🛠️ Technical Improvements
- Advanced context triggers with file content pattern matching
- Clean TypeScript architecture with proper error handling
- ESLint compliant code with type safety
- Comprehensive test suite with 12 test projects

### 🐛 Bug Fixes
- Fixed CSP violations in webviews
- Resolved JavaScript errors in template manager
...
- 🏷️ Visual Tags: Filter tasks by category (All, Setup, Development, Build, Testing, Code Quality, Deployment, Maintenance)
...
- 🏗️ One-Click Task Template Creation: Toolbar button in "My Commands" to auto-generate project workflows
